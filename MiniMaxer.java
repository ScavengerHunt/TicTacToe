...
public class MiniMaxer {
	...
	public static boolean rows, columns, dia;
	public static int[] originState;
	public static final int UTIL=3000;

	//return the A-B-Search result, the action to be taken
	public static int abSearch(int[] state){
		expandedNodes=0;
	...
	public static int getUtility(int[] state){
	...
	public static int[] getResult(int[] s, int where ,int who){
	...
	public static double getScore(int[] s){
		double score = 0;
		int counter1=0;
		int counter2=0;
		//row score
	...
	public static double maxValue(int[] state,int d,double alpha, double beta) {
	expandedNodes++;
	...
	public static double minValue(int[] state,int d, double alpha, double beta) {
	expandedNodes++;
	...
	public static void main(String args[]){
		...
		System.out.println("position:" + MiniMaxer.abSearch(state));
